...
STOCK_POOL = [
    ...
    {'Ticker': '1295.KL', 'Name': 'PBBANK'},
    {'Ticker': '1023.KL', 'Name': 'CIMB'},
    {'Ticker': '5347.KL', 'Name': 'TENAGA'},
    {'Ticker': '5225.KL', 'Name': 'IHH'},
    {'Ticker': '8869.KL', 'Name': 'PMETAL'},
    {'Ticker': '5819.KL', 'Name': 'HLBANK'},
    {'Ticker': '5183.KL', 'Name': 'PCHEM'},
    {'Ticker': '5285.KL', 'Name': 'SDG'},
    {'Ticker': '5211.KL', 'Name': 'SUNWAY'},
    {'Ticker': '6742.KL', 'Name': 'YTLPOWR'},
    {'Ticker': '3816.KL', 'Name': 'MISC'},
    {'Ticker': '1066.KL', 'Name': 'RHBBANK'},
    {'Ticker': '6033.KL', 'Name': 'PETGAS'},
    {'Ticker': '6947.KL', 'Name': 'CDB'},
    {'Ticker': '4863.KL', 'Name': 'TM'},
    {'Ticker': '6012.KL', 'Name': 'MAXIS'},
    {'Ticker': '5326.KL', 'Name': '99SMART'},
    {'Ticker': '4677.KL', 'Name': 'YTL'},
    {'Ticker': '1961.KL', 'Name': 'IOICORP'},
    {'Ticker': '5398.KL', 'Name': 'GAMUDA'},
    {'Ticker': '5249.KL', 'Name': 'IOIPG'},
    {'Ticker': '4707.KL', 'Name': 'NESTLE'},
    {'Ticker': '2445.KL', 'Name': 'KLK'},
    {'Ticker': '1082.KL', 'Name': 'HLFG'},
    {'Ticker': '1015.KL', 'Name': 'AMBANK'},
    {'Ticker': '6888.KL', 'Name': 'AXIATA'},
    {'Ticker': '5681.KL', 'Name': 'PETDAG'},
    {'Ticker': '5246.KL', 'Name': 'WPRTS'},
    {'Ticker': '2089.KL', 'Name': 'UTDPLT'},
    {'Ticker': '4065.KL', 'Name': 'PPB'},
    {'Ticker': '5296.KL', 'Name': 'MRDIY'},
    {'Ticker': '5878.KL', 'Name': 'KPJ'},
    {'Ticker': '4197.KL', 'Name': 'SIME'},
    {'Ticker': '7084.KL', 'Name': 'QL'},
    {'Ticker': '5227.KL', 'Name': 'IGBREIT'},
    {'Ticker': '7277.KL', 'Name': 'DIALOG'},
    {'Ticker': '5031.KL', 'Name': 'TIMECOM'},
    {'Ticker': '4715.KL', 'Name': 'GENM'},
    {'Ticker': '0097.KL', 'Name': 'VITROX'},
    {'Ticker': '3689.KL', 'Name': 'F&N'},
    {'Ticker': '5288.KL', 'Name': 'SIMEPROP'},
    {'Ticker': '3794.KL', 'Name': 'MCEMENT'},
    {'Ticker': '3182.KL', 'Name': 'GENTING'},
    {'Ticker': '5263.KL', 'Name': 'SUNCON'},
    {'Ticker': '3867.KL', 'Name': 'MPI'},
    {'Ticker': '5176.KL', 'Name': 'SUNREIT'},
    {'Ticker': '1899.KL', 'Name': 'BKAWAN'},
    {'Ticker': '2488.KL', 'Name': 'ABMB'},
    {'Ticker': '3336.KL', 'Name': 'IJM'},
    ...
    {'Ticker': '8206.KL', 'Name': 'ECOWLD'},
    {'Ticker': '7113.KL', 'Name': 'TOPGLOV'},
    {'Ticker': '3255.KL', 'Name': 'HEIM'},
    {'Ticker': '5209.KL', 'Name': 'GASMSIA'},
    {'Ticker': '0208.KL', 'Name': 'GREATEC'},
    {'Ticker': '7293.KL', 'Name': 'YINSON'},
    {'Ticker': '5005.KL', 'Name': 'UNISEM'},
    {'Ticker': '3301.KL', 'Name': 'HLIND'},
    {'Ticker': '5185.KL', 'Name': 'AFFIN'},
    {'Ticker': '5292.KL', 'Name': 'UWC'},
    {'Ticker': '5053.KL', 'Name': 'OSK'},
    {'Ticker': '8621.KL', 'Name': 'LPI'},
    {'Ticker': '8664.KL', 'Name': 'SPSETIA'},
    {'Ticker': '4731.KL', 'Name': 'SCIENTX'},
    {'Ticker': '1171.KL', 'Name': 'MBSB'},
    {'Ticker': '0151.KL', 'Name': 'KGB'},
    {'Ticker': '5258.KL', 'Name': 'BIMB'},
    {'Ticker': '2836.KL', 'Name': 'CARLSBG'},
    {'Ticker': '5200.KL', 'Name': 'UOADEV'},
    {'Ticker': '5309.KL', 'Name': 'ITMAX'},
    {'Ticker': '5606.KL', 'Name': 'IGBB'},
    {'Ticker': '2291.KL', 'Name': 'GENP'},
    {'Ticker': '5323.KL', 'Name': 'JPG'},
    {'Ticker': '5264.KL', 'Name': 'MALAKOF'},
    {'Ticker': '5168.KL', 'Name': 'HARTA'},
    {'Ticker': '4006.KL', 'Name': 'ORIENT'},
    {'Ticker': '5306.KL', 'Name': 'FFB'},
    {'Ticker': '5106.KL', 'Name': 'AXREIT'},
    {'Ticker': '5126.KL', 'Name': 'SOP'},
    {'Ticker': '1163.KL', 'Name': 'ALLIANZ'},
    {'Ticker': '7172.KL', 'Name': 'PMBTECH'},
    {'Ticker': '5038.KL', 'Name': 'KSL'},
    {'Ticker': '5286.KL', 'Name': 'MI'},
    {'Ticker': '5148.KL', 'Name': 'UEMS'},
    {'Ticker': '7153.KL', 'Name': 'KOSSAN'},
    {'Ticker': '3069.KL', 'Name': 'MFCB'},
    {'Ticker': '7160.KL', 'Name': 'PENTA'},
    {'Ticker': '5139.KL', 'Name': 'AEONCR'},
    {'Ticker': '9822.KL', 'Name': 'SAM'},
    {'Ticker': '6139.KL', 'Name': 'TAKAFUL'},
    {'Ticker': '7161.KL', 'Name': 'KERJAYA'},
    {'Ticker': '5401.KL', 'Name': 'TROP'},
    ...
    {'Ticker': '5012.KL', 'Name': 'TAANN'},
    {'Ticker': '5000.KL', 'Name': 'HUMEIND'},
    {'Ticker': '5250.KL', 'Name': 'SEM'},
    {'Ticker': '5102.KL', 'Name': 'GCB'},
    {'Ticker': '0225.KL', 'Name': 'SCGBHD'},
    {'Ticker': '3565.KL', 'Name': 'WCEHB'},
    {'Ticker': '0338.KL', 'Name': 'KOPI'},
    {'Ticker': '5141.KL', 'Name': 'DAYANG'},
    {'Ticker': '5180.KL', 'Name': 'CLMT'},
    {'Ticker': '5210.KL', 'Name': 'ARMADA'},
    {'Ticker': '6459.KL', 'Name': 'MNRB'},
    {'Ticker': '3026.KL', 'Name': 'DLADY'},
    {'Ticker': '7195.KL', 'Name': 'BNASTRA'},
    {'Ticker': '5983.KL', 'Name': 'MBMR'},
    {'Ticker': '3417.KL', 'Name': 'E&O'},
    {'Ticker': '5255.KL', 'Name': 'LFG'},
    {'Ticker': '5162.KL', 'Name': 'VSTECS'},
    {'Ticker': '3859.KL', 'Name': 'MAGNUM'},
    {'Ticker': '4162.KL', 'Name': 'BAT'},
    {'Ticker': '5109.KL', 'Name': 'YTLREIT'},
    {'Ticker': '1562.KL', 'Name': 'SPTOTO'},
    {'Ticker': '5138.KL', 'Name': 'HSPLANT'},
    {'Ticker': '5313.KL', 'Name': 'RADIUM'},
    {'Ticker': '9296.KL', 'Name': 'RCECAP'},
    {'Ticker': '5330.KL', 'Name': 'TMK'},
    {'Ticker': '1651.KL', 'Name': 'MRCB'},
    {'Ticker': '7081.KL', 'Name': 'PHARMA'},
    {'Ticker': '9059.KL', 'Name': 'TSH'},
    {'Ticker': '6599.KL', 'Name': 'AEON'},
    {'Ticker': '7103.KL', 'Name': 'SPRITZER'},
    {'Ticker': '5301.KL', 'Name': 'CTOS'},
    {'Ticker': '5338.KL', 'Name': 'PARADIGM'},
    {'Ticker': '5199.KL', 'Name': 'HIBICUS'},
    {'Ticker': '0351.KL', 'Name': 'LSH'},
    {'Ticker': '5299.KL', 'Name': 'IGBCR'},
    {'Ticker': '0245.KL', 'Name': 'MNHLDG'},
    {'Ticker': '7052.KL', 'Name': 'PADINI'},
    {'Ticker': '7100.KL', 'Name': 'UCHITEC'},
    {'Ticker': '5321.KL', 'Name': 'KEYFIELD'},
    {'Ticker': '0303.KL', 'Name': 'ALPHA'},
    {'Ticker': '5327.KL', 'Name': 'MEGAFB'},
    {'Ticker': '0045.KL', 'Name': 'SSB8'},
    {'Ticker': '5335.KL', 'Name': 'HI'},
    {'Ticker': '7148.KL', 'Name': 'DPHARMA'},
    {'Ticker': '7179.KL', 'Name': 'LAGENDA'},
    {'Ticker': '0056.KL', 'Name': 'NCT'},
    {'Ticker': '2593.KL', 'Name': 'UMCCA'},
    {'Ticker': '3042.KL', 'Name': 'PETRONM'},
    {'Ticker': '8907.KL', 'Name': 'EG'},
    {'Ticker': '5248.KL', 'Name': 'BAUTO'},
    {'Ticker': '0233.KL', 'Name': 'PEKAT'},
    {'Ticker': '0339.KL', 'Name': 'CBHB'},
    {'Ticker': '5271.KL', 'Name': 'PECCA'},
    {'Ticker': '4383.KL', 'Name': 'JTIASA'},
    {'Ticker': '5135.KL', 'Name': 'SWKPLNT'},
    {'Ticker': '6718.KL', 'Name': 'CRESNDO'},
    {'Ticker': '4758.KL', 'Name': 'ANCOMNY'},
    {'Ticker': '6262.KL', 'Name': 'INNO'},
    {'Ticker': '5302.KL', 'Name': 'ATECH'},
    ...
    {'Ticker': '0375.KL', 'Name': 'THMY'},
    {'Ticker': '5307.KL', 'Name': 'AMEREIT'},
